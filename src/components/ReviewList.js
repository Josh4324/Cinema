            ...
            <div className="contain py-3">
                <div className="container1">
                        <div className="row">
                            {
                                datalist.map((data) => {
                                    return <Review1 me={me} vc={vc} user_meid={user_meid} addComment={addComment} key={data.key} disLikes={disLikes} addLikes={addLikes}  newdata={data} history={history} logState={logState} />
                                })
                            }
                        </div>
                </div>
